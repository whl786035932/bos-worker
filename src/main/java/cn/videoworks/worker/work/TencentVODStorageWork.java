...
import cn.videoworks.worker.function.WriteTencentVODStorage;
 ...
 * @see 	 
 */
public class TencentVODStorageWork {
	
	private static Logger log = LoggerFactory.getLogger(TencentVODStorageWork.class);
	...
	public static void registWorker(String storageClient){
        ...
        if(StringUtils.isNotBlank(gearmanIp) && -1 != gearmanPort) {
	        ...
	        worker.addFunction(WorkerFunctionConstant.TENCENT_VOD_OBJ_INSTORAGE, new WriteTencentVODStorage());
