 ...
 * @see 	 
 */
public class BaiduBosStorageWork {
	
	private static Logger log = LoggerFactory.getLogger(BaiduBosStorageWork.class);
	...
	public static void registWorker(){
        ...
        if(StringUtils.isNotBlank(gearmanIp) && -1 != gearmanPort) {
	        ...
	        worker.addFunction(WorkerFunctionConstant.BAIDU_BOS_OBJ_INSTORAGE, new WriteBosStorage());
