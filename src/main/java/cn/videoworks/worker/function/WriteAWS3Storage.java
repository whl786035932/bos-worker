...
import cn.videoworks.worker.client.AWSS3Client;
 ...
 *
 */
public class WriteAWS3Storage implements GearmanFunction {

	public WriteAWS3Storage() {

	}


	private static final Logger log = LoggerFactory.getLogger(WriteAWS3Storage.class);
...
//					AWSS3Client.getAmazonS3Client().putObjectWithTransferManager(bucketName, check_sum, file, true);//分段上传
